...
if ( ! class_exists( 'WPSP_Cp_Portfolio' ) ) {
	class WPSP_Cp_Portfolio {
		...
		public function __construct() {
			...
			$this->label = $this->label ? $this->label : _x( 'Portfolio', 'Portfolio Post Type Label', 'smallshop' );
		...
		public function register_post_type() {
			...
			$singular_name    = $singular_name ? $singular_name : esc_html__( 'Portfolio Item', 'smallshop' );
			...
			$args = array(
				'labels' => array(
					...
					'add_new' => esc_html__( 'Add New', 'smallshop' ),
					'all_items' => esc_html__( 'All ' . $name, 'smallshop' ),
					'add_new_item' => esc_html__( 'Add New Item', 'smallshop' ),
					'edit_item' => esc_html__( 'Edit Item', 'smallshop' ),
					'new_item' => esc_html__( 'Add New Item', 'smallshop' ),
					'view_item' => esc_html__( 'View Item', 'smallshop' ),
					'search_items' => esc_html__( 'Search Items', 'smallshop' ),
					'not_found' => esc_html__( 'No Items Found', 'smallshop' ),
					'not_found_in_trash' => esc_html__( 'No Items Found In Trash', 'smallshop' )
				),
				'public' => true,
		...
		public static function register_tags() {
			...
			$name = $name ? $name : esc_html__( 'Portfolio Tags', 'smallshop' );
			...
			$args = array(
				'labels' => array(
					...
					'singular_name' => $name,
					'menu_name' => $name,
					'search_items' => esc_html__( 'Search','comics-arts' ),
					'popular_items' => esc_html__( 'Popular', 'smallshop' ),
					'all_items' => esc_html__( 'All', 'smallshop' ),
					'parent_item' => esc_html__( 'Parent', 'smallshop' ),
					'parent_item_colon' => esc_html__( 'Parent', 'smallshop' ),
					'edit_item' => esc_html__( 'Edit', 'smallshop' ),
					'update_item' => esc_html__( 'Update', 'smallshop' ),
					'add_new_item' => esc_html__( 'Add New', 'smallshop' ),
					'new_item_name' => esc_html__( 'New', 'smallshop' ),
					'separate_items_with_commas' => esc_html__( 'Separate with commas', 'smallshop' ),
					'add_or_remove_items' => esc_html__( 'Add or remove', 'smallshop' ),
					'choose_from_most_used' => esc_html__( 'Choose from the most used', 'smallshop' ),
				),
				'public' => true,
		...
		public static function register_categories() {
			...
			$name = $name ? $name : esc_html__( 'Portfolio Categories', 'smallshop' );
		...
		public static function edit_columns( $columns ) {
			if ( taxonomy_exists( 'portfolio_category' ) ) {
				$columns['portfolio_category'] = esc_html__( 'Category', 'smallshop' );
			}
			if ( taxonomy_exists( 'portfolio_tag' ) ) {
				$columns['portfolio_tag']      = esc_html__( 'Tags', 'smallshop' );
			}
			return $columns;
		}
		...
		public function add_page() {
			$wpsp_portfolio_editor = add_submenu_page(
				...
				esc_html__( 'Post Type Editor', 'smallshop' ),
				esc_html__( 'Post Type Editor', 'smallshop' ),
				'administrator',
		...
		public static function sanitize( $options ) {
			...
			add_settings_error(
				...
				esc_html__( 'Settings saved and rewrite rules flushed.', 'smallshop' ),
				'updated'
			);
		...
		public static function create_admin_page() { ?>
			<div class="wrap">
				<h2><?php esc_html_e( 'Post Type Editor', 'smallshop' ); ?></h2>
				<form method="post" action="options.php">
				<?php settings_fields( 'wpsp_portfolio_options' ); ?>
				<table class="form-table">
					<tr valign="top">
						<th scope="row"><?php esc_html_e( 'Admin Icon', 'smallshop' ); ?></th>
						<td>
							<?php
							// Mod
					...
					<tr valign="top">
						<th scope="row"><?php esc_html_e( 'Enable Custom Sidebar', 'smallshop' ); ?></th>
						<?php
						// Get checkbox value
					...
					<tr valign="top">
						<th scope="row"><?php esc_html_e( 'Include In Search', 'smallshop' ); ?></th>
						<?php
						// Get checkbox value
					...
					<tr valign="top">
						<th scope="row"><?php esc_html_e( 'Post Type: Name', 'smallshop' ); ?></th>
						<td><input type="text" name="wpsp_portfolio_editor[portfolio_labels]" value="<?php echo get_option( 'portfolio_labels' ); ?>" /></td>
					</tr>
					<tr valign="top">
						<th scope="row"><?php esc_html_e( 'Post Type: Singular Name', 'smallshop' ); ?></th>
					...
					<tr valign="top" id="wpsp-tags-enable">
						<th scope="row"><?php esc_html_e( 'Enable Tags', 'smallshop' ); ?></th>
						<?php
						// Get checkbox value
					...
					<tr valign="top" id="wpsp-tags-label">
						<th scope="row"><?php esc_html_e( 'Tags: Label', 'smallshop' ); ?></th>
					...
					<tr valign="top" id="wpsp-tags-slug">
						<th scope="row"><?php esc_html_e( 'Tags: Slug', 'smallshop' ); ?></th>
					...
					<tr valign="top" id="wpsp-categories-enable">
						<th scope="row"><?php esc_html_e( 'Enable Categories', 'smallshop' ); ?></th>
						<?php
						// Get checkbox value
					...
					<tr valign="top" id="wpsp-categories-label">
						<th scope="row"><?php esc_html_e( 'Categories: Label', 'smallshop' ); ?></th>
					...
					<tr valign="top" id="wpsp-categories-slug">
						<th scope="row"><?php esc_html_e( 'Categories: Slug', 'smallshop' ); ?></th>
		...
		public static function register_sidebar() {
			...
			register_sidebar( array(
				'name'          => $post_type_name .' '. esc_html__( 'Sidebar', 'smallshop' ),
