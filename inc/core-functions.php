...
function wpsp_get_excerpt( $args = array() ) {
	...
	if ( $post->post_password ) :
		...
		$output = esc_html__( 'This is a password protected post.', 'smallshop' );
	...
	if ( $readmore ) :
		...
		$read_more_text = isset( $args['read_more_text'] ) ? $args['read_more_text'] : esc_html__( 'Read more', 'smallshop' );
...
if ( is_admin() && apply_filters( 'wpsp_dashboard_thumbnails', true ) ) :
	...
	if ( ! function_exists( 'wpsp_posts_columns' ) ) {
		function wpsp_posts_columns( $defaults ){
			$defaults['wpsp_post_thumbs'] = esc_html__( 'Featured Image', 'smallshop' );
			return $defaults;
		}
	}
...
function wpsp_social_share_heading() {
    ...
    $heading = $heading ? $heading : esc_html__( 'Please Share This', 'smallshop' );
...
function wpsp_image_crop_locations() {
	return array(
		''              => esc_html__( 'Default', 'smallshop' ),
		'left-top'      => esc_html__( 'Top Left', 'smallshop' ),
		'right-top'     => esc_html__( 'Top Right', 'smallshop' ),
		'center-top'    => esc_html__( 'Top Center', 'smallshop' ),
		'left-center'   => esc_html__( 'Center Left', 'smallshop' ),
		'right-center'  => esc_html__( 'Center Right', 'smallshop' ),
		'center-center' => esc_html__( 'Center Center', 'smallshop' ),
		'left-bottom'   => esc_html__( 'Bottom Left', 'smallshop' ),
		'right-bottom'  => esc_html__( 'Bottom Right', 'smallshop' ),
		'center-bottom' => esc_html__( 'Bottom Center', 'smallshop' ),
	);
}
endif;
...
function wpsp_image_hovers() {
	return apply_filters( 'wpsp_image_hovers', array(
		''             => esc_html__( 'Default', 'smallshop' ),
		'opacity'      => esc_html__( 'Opacity', 'smallshop' ),
		'grow'         => esc_html__( 'Grow', 'smallshop' ),
		'shrink'       => esc_html__( 'Shrink', 'smallshop' ),
		'side-pan'     => esc_html__( 'Side Pan', 'smallshop' ),
		'vertical-pan' => esc_html__( 'Vertical Pan', 'smallshop' ),
		'tilt'         => esc_html__( 'Tilt', 'smallshop' ),
		'blurr'        => esc_html__( 'Normal - Blurr', 'smallshop' ),
		'blurr-invert' => esc_html__( 'Blurr - Normal', 'smallshop' ),
		'sepia'        => esc_html__( 'Sepia', 'smallshop' ),
