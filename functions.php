<?php
/**
 * SmallShop functions and definitions.
 *
...
class WPSP_Theme_Setup {
	...
	public static function constants(){
		// Theme branding
		define( 'WPSP_THEME_BRANDING', 'SmallShop' );
	...
	public static function theme_setup() {
		...
		// Load text domain
		load_theme_textdomain( 'smallshop', WPSP_THEME_DIR .'/languages' );
		...
		$menus = apply_filters( 'wpsp_nav_menus', array(
			'topbar_menu'     => esc_html__( 'Top Bar', 'smallshop' ),
			'main_menu'       => esc_html__( 'Main', 'smallshop' ),
			'mobile_menu_alt' => esc_html__( 'Mobile Menu Alternative', 'smallshop' ),
			'mobile_menu'     => esc_html__( 'Mobile Icons', 'smallshop' ),
			'footer_menu'     => esc_html__( 'Footer', 'smallshop' ),
		) );
